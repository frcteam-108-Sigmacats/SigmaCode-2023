...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    ...
    PathPlannerTrajectory pathGroupPath = PathPlanner.loadPath("PathTesting", new PathConstraints(2, 1));
    ...
    PPSwerveControllerCommand swerveControllerCommand = new PPSwerveControllerCommand(pathGroupPath, swerveSubsystem::getPose, SwerveConstants.swerveKinematics, new PIDController(0.05, 0, 0), new PIDController(0.05, 0, 0), new PIDController(0.001, 0, 0), swerveSubsystem::setModuleStates, false, swerveSubsystem);

    Command fullauto = autoBuilder.fullAuto(tryGroup);
    Command semiAuto = new SequentialCommandGroup(new InstantCommand(() -> swerveSubsystem.resetOdometry(pathGroupPath.getInitialHolonomicPose())), swerveControllerCommand);
    return semiAuto;
  }
}
