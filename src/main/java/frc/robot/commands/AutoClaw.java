...
public class AutoClaw extends CommandBase {
  ...
  private final ClawMechanism clawMech;
  private final double extendArmState = 0;
  private final double startArmConfigState = 0;
   ...
   */
  public AutoClaw(ClawMechanism clawSub) {
    clawMech = clawSub;
